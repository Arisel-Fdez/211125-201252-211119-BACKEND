...
exports.ViewImagesController = void 0;
const admin = __importStar(require("firebase-admin"));
class ViewImagesController {
    constructor(viewImagesUseCase) {
        this.viewImagesUseCase = viewImagesUseCase;
    }
    run(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const publications = yield this.viewImagesUseCase.run();
...
exports.ViewImagesController = ViewImagesController;
