...
exports.ViewPDFController = void 0;
const admin = __importStar(require("firebase-admin"));
class ViewPDFController {
    constructor(viewPDFUseCase) {
        this.viewPDFUseCase = viewPDFUseCase;
    }
    run(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const publications = yield this.viewPDFUseCase.run();
...
exports.ViewPDFController = ViewPDFController;
