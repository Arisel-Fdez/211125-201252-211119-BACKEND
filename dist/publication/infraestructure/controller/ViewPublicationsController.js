...
exports.ViewPublicationsController = void 0;
const admin = __importStar(require("firebase-admin"));
class ViewPublicationsController {
    constructor(viewPublicationsUseCase) {
        this.viewPublicationsUseCase = viewPublicationsUseCase;
    }
    run(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const publications = yield this.viewPublicationsUseCase.run();
...
exports.ViewPublicationsController = ViewPublicationsController;
