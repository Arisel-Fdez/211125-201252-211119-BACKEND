...
exports.ViewVideosController = void 0;
const admin = __importStar(require("firebase-admin"));
class ViewVideosController {
    constructor(viewVideosUseCase) {
        this.viewVideosUseCase = viewVideosUseCase;
    }
    run(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const publications = yield this.viewVideosUseCase.run();
...
exports.ViewVideosController = ViewVideosController;
