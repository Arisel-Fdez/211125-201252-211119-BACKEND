...
exports.ViewAudiosController = void 0;
const admin = __importStar(require("firebase-admin"));
class ViewAudiosController {
    constructor(viewAudiosUseCase) {
        this.viewAudiosUseCase = viewAudiosUseCase;
    }
    run(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const publications = yield this.viewAudiosUseCase.run();
...
exports.ViewAudiosController = ViewAudiosController;
