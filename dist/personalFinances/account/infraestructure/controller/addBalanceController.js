...
exports.AddBalanceController = void 0;
class AddBalanceController {
    constructor(addBalanceUseCase) {
    ...
    run(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.addBalanceUseCase.run(parseInt(userId), balance, description, categoryId);
...
exports.AddBalanceController = AddBalanceController;
